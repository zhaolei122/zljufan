...
public class HotAdapter extends BaseAdapter {
    ...
    public HotAdapter(Context context, List<BeanHot.ContentBean.ListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new VHolder();
            convertView = View.inflate(context, R.layout.hot_grid_item, null);
            vh.bimg = (ImageView) convertView.findViewById(R.id.hot_bigheadimg);
            vh.name = (TextView) convertView.findViewById(R.id.hot_name);
            vh.place = (TextView) convertView.findViewById(R.id.hot_place);
        ...
        //ImageUrl.images[i]
        mImageLoader.displayImage(list.get(position).getBigheadimg(), vh.bimg, options);
