...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void findViewById(Context context) {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.li_room_praise_0);
    ...
    private static int[] drawableIds = new int[]{R.mipmap.li_room_praise_0, R.mipmap.li_room_praise_1, R.mipmap.li_room_praise_2, R.mipmap.li_room_praise_3, R.mipmap.li_room_praise_4, R.mipmap.li_room_praise_5, R.mipmap.li_room_praise_6, R.mipmap.li_room_praise_7, R.mipmap.li_room_praise_8, R.mipmap.li_room_praise_9, R.mipmap.li_room_praise_10, R.mipmap.li_room_praise_11};
