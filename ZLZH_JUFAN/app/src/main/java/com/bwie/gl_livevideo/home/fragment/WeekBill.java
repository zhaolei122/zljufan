...
public class WeekBill extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.week_bill, container, false);
        lv = (ListView) view.findViewById(R.id.week_list);
    ...
    private void into() {
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    open = (HttpURLConnection) new URL("http://api.vas.jufan.tv/cgi/rank/sendTopWeek?r=mvohabl&page=1&user_id=500059702&sign=1425BC86225D0897C7A2F6A63F6AD0C99933122D").openConnection();
                    // 设置连接超时时间
